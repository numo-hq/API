...
describe("Lendgines", () => {
  ...
  test("Save Mint from event", () => {
    ...
    assert.fieldEquals(
      ...
      "0x00000000#1",
      "lendgine",
      AddressThree.toHexString(),
    );
    assert.fieldEquals(
      MintEntityType,
      "0x00000000#1",
      "sender",
      AddressOne.toHexString(),
    );
    assert.fieldEquals(
      MintEntityType,
      "0x00000000#1",
      "recipient",
      AddressTwo.toHexString(),
    );
    assert.fieldEquals(
      MintEntityType,
      "0x00000000#1",
  ...
  test("Save Accrue Position Interest from event", () => {
    const accrueInterestEvent = createAccruePositionInterestEvent(
      AddressOne,
      BigInt.fromString("1000000000000000000"),
    );
  ...
  test("Save Collect from event", () => {
    const collectEvent = createCollectEvent(
      AddressOne,
      AddressTwo,
      BigInt.fromString("1000000000000000000"),
    );
