...
import {
  ...
  Mint as PairMint,
  Swap,
} from "../src/types/templates/Lendgine/Pair";
...
export const AddressOne = Address.fromString(
  "0x0000000000000000000000000000000000000001",
);
export const AddressTwo = Address.fromString(
  "0x0000000000000000000000000000000000000002",
);
export const AddressThree = Address.fromString(
  "0x0000000000000000000000000000000000000003",
);
export const AddressFour = Address.fromString(
...
export function createLendgineCreatedEvent(
  ...
  const token0Param = new ethereum.EventParam(
    "token0",
    ethereum.Value.fromAddress(token0),
  );
  const token1Param = new ethereum.EventParam(
    "token1",
    ethereum.Value.fromAddress(token1),
  );
  const token0ExpParam = new ethereum.EventParam(
    "token0Exp",
    ethereum.Value.fromUnsignedBigInt(token0Exp),
  );
  const token1ExpParam = new ethereum.EventParam(
    "token1Exp",
    ethereum.Value.fromUnsignedBigInt(token1Exp),
  );
  const upperBoundParam = new ethereum.EventParam(
    "upperBound",
    ethereum.Value.fromUnsignedBigInt(upperBound),
  );
  const lendgineParam = new ethereum.EventParam(
    "lendgine",
    ethereum.Value.fromAddress(lendgine),
  );
...
export function createMintEvent(
  ...
  const collateralParam = new ethereum.EventParam(
    "collateral",
  ...
  const liquidityParam = new ethereum.EventParam(
    "liquidity",
    ethereum.Value.fromUnsignedBigInt(liquidity),
  );
  const toParams = new ethereum.EventParam(
    "sender",
...
export function createDepositEvent(
  ...
  const sizeParam = new ethereum.EventParam(
    "size",
...
export function createPairMintEvent(
  ...
  const amount0Param = new ethereum.EventParam(
    "amount0In",
    ethereum.Value.fromUnsignedBigInt(amount0In),
  );
  const amount1Param = new ethereum.EventParam(
    "amount1In",
...
export function createAccrueInterestEvent(
  ...
  const timeElapsedParam = new ethereum.EventParam(
    "timeElapsed",
...
export function createAccruePositionInterestEvent(
  ...
  const accruePositionInterestEvent = changetype<AccruePositionInterest>(
    newMockEvent(),
  );
